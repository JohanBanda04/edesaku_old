...
<div class="text-center row">
    <div class="form-signin col-md-4 offset-md-4">
        <form method="post">
            <h5 class="mb-3">Laaman masuk pengguna</h5>
            @csrf
            ...
            <div class="input-group mb-3">
                <input type="password" name="password" class="form-control" placeholder="Sandii" id="inputPassword">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-4">
                    <div class="float-end">
                        <button type="submit" class="btn btn-primary">Massuk</button>
                    </div>
                </div>
            </div>
        </form>
